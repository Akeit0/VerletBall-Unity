...
namespace ZimGui.Core {
    ...
    public struct VertexData {
        ...
        public void Write(Vector2 position, float size, UiColor color, Vector2 uv) {
            Position = position;
            Color = color;
            UV = uv;
            Size = size;
        ...
        public void Write(Vector2 position, float size, UiColor color, float uvX, float uvY) {
            Position = position;
            Color = color;
        ...
        public void Write(float x, float y, float size, UiColor color, float uvX, float uvY) {
            Position.x = x;
            Position.y = y;
            Color = color;
            UV = new Vector2(uvX, uvY);
    ...
    public struct Quad {
        ...
        public void WriteLine(Vector2 start, Vector2 end, float width, UiColor color, Vector2 quadUV) {
            ...
            V3.Size = V2.Size = V1.Size = V0.Size = 255;
        ...
        public void WriteCircle(Vector2 center, float radius, UiColor color, in Vector4 circleUV) {
            radius *= 1.17f;
            V3.Size = V2.Size = V1.Size = V0.Size = radius*4;
            V3.Color = V2.Color = V1.Color = V0.Color = color;
        ...
        public void SetSize(float size) {
            V3.Size = V2.Size = V1.Size = V0.Size = size;
        }

        public void SetColorAndSize(UiColor color, float size) {
            V3.Color = V2.Color = V1.Color = V0.Color = color;
            V3.Size = V2.Size = V1.Size = V0.Size = size;
        }
